...
/**
 * The site navigation: the fixed sections, plus any page she has created and
 * left ticked as "Show in the menu".
 *
 * The fixed items carry orders 10–45 and new pages default to 50, so adding a
